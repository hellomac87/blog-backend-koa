...
exports.checkObjectId = (ctx, next) => {
    ...
    return next(); // next를 리턴해야 ctx.body 가 제대로 설정됩니다.
}
/* POST /api/posts
{ title, body, tags }
*/
exports.write = async(ctx) => {
    ...
    const schema = Joi.object().keys({
      title: Joi.string().required(), // 뒤에 required 를 붙여 주면 필수 항목이라는 의미
